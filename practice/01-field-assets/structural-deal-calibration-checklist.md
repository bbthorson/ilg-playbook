---
title: "Structural Deal Calibration Checklist"
layer: practice
status: active
...
# Structural Deal Calibration Checklist
...
- [ ] **The deal is not sitting on a boundary condition.** Walk the six in [01-motion-taxonomy.md](../../theory/01-foundation/01-motion-taxonomy.md). Name which one you checked and why it does not apply.
...
- [deal-triage-calculator.md](./deal-triage-calculator.md) — Step 0 workflow maturity, the three counts, and the level and direction.
