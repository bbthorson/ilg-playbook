...
**Open question this source raises.** The [Deal Triage Calculator](../../practice/01-field-assets/deal-triage-calculator.md) Step 0 currently treats workflow maturity, market stage, and asset specificity as three independent axes. The misfit literature suggests workflow codification and implementation cost are coupled rather than independent, because codification is itself a relationship-specific investment. Resolving this requires deciding whether workflow definition and workflow divergence are one variable or two. Recorded here rather than acted on.
