...
- **Milestone Valuation Model** — applies staged uncertainty decay to gate design. See [milestone-valuation-model.md](../../practice/01-field-assets/milestone-valuation-model.md).
