...
2. **[00-ilg-constitution.md](./00-ilg-constitution.md)** — The full economic and behavioral framework, structured as a deductive system. Four parts:
   ...
   - **Part II:** Derived Concepts — primary derivations from each axiom (Boundary Condition, Friction Allocation Principles, Recursive Cooperation, Reputation Depreciation), bridge concepts (Decay Clock, Effective Cost, Staged Commitment, Surplus), and clarifying concepts
